defmodule WPSWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :wps
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :wps
  end
